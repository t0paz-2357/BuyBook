				...
				<div class="container-fluid px-4">
					...
					<ol class="breadcrumb mb-4">
						...
						<li class="breadcrumb-item">
							<a href="/admin/noticeDelete">공지 사항 삭제</a>
						</li>
					</ol>
					<!--                    공지 사항 목록-->
					<div class="card mb-4">
						<div class="card-body">현재 추가하고자 하는 공지 사항이 존재하는지 미리 확인하세요!</div>
					</div>
					<div class="card mb-4">
				...
				<div class="container px-4 px-lg-5">
					<div class="row justify-content-center">
						<div class="card shadow-lg border-5 rounded-lg mt-5">
							...
							<div class="card-body">
								<form action="/admin/noticeAdd" method="POST">
									<div class="form-floating mb-3">
										<input class="form-control" id="inputNoticeTitle" type="text" placeholder="공지 사항 제목을 입력해주세요." name="inputNoticeTitle" />
										<label for="inputNoticeTitle">공지 사항 제목</label>
									</div>
									<div class="form-group">
										<textarea class="form-control" id="inputNoticeContent" placeholder="공지 사항 내용을 입력해주세요." rows="10" name="inputNoticeContent"></textarea>
									</div>
									<div id="inputNoticeContentCount">(0 / 1000)</div>
									<div class="mt-4 mb-0">
										<div class="d-grid">
											<input type="submit" class="btn btn-primary btn-block" value="공지 사항을 추가합니다." />
										</div>
									</div>
								</form>
							</div>
